...
export function SavedCardsScreen() {
  ...
  const handleEditPress = useCallback(
    (card: SavedCard) => {
      openModal({
        message: `Editing card ending in ${card.lastFour} will be available soon.`,
        title: 'Edit card',
        tone: 'info',
      });
    },
  ...
  const handleRemovePress = useCallback(
    (card: SavedCard) => {
      openModal({
        ...
        message: `Remove the card ending in ${card.lastFour}?`,
        title: 'Remove card',
        tone: 'warning',
      });
    },
  ...
  const handleSaveCard = useCallback(
    (values: SavedCardFormValues) => {
      ...
      openModal({
        message: `Card ending in ${newCard.lastFour} was saved.`,
        title: 'Card saved',
        tone: 'success',
      });
    },
